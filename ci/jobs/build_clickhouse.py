...
def main():
    ...
    if res and JobStages.BUILD in stages:
        if build_type == BuildTypes.ARM_FUZZERS:
            targets = "fuzzers"
        elif build_type == BuildTypes.ARM_UTILS:
            # Build utils/tools for CI checks (parser_memory_profiler, etc.)
            targets = "parser_memory_profiler"
        elif build_type in (
            BuildTypes.AMD_TIDY,
            BuildTypes.ARM_TIDY,
